...
<div class=\"pull-right\">
    ...
    <div class=\"well\">
        ...
        // line 80
        echo "            ";
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 80, $this->source); })()), "Specialites", [], "any", false, false, false, 80), 'label', ["label_attr" => ["class" => "cal-sm-2 control-label"], "label" => "Specialité"]);
        echo "
            ";
        // line 82
        echo "            ";
...
<div class=\"pull-right\">
    ...
    <div class=\"well\">
        ...
        <div class=\"form-group\">
            {# Génération du label #}
            {{ form_label(form.prenom, \"Prénom de l'agent\", {'label_attr': {'class': 'cal-sm-2 control-label'}}) }}
            {# Affichage des erreurs pour ce champ précis #}
        ...
        <div class=\"form-group\">
            {# Génération du label #}
            {{ form_label(form.Specialites, \"Specialité\", {'label_attr': {'class': 'cal-sm-2 control-label'}}) }}
            {# Affichage des erreurs pour ce champ précis #}
