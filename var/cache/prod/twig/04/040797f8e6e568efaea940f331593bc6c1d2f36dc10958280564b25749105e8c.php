...
class __TwigTemplate_b17792daa0cae451a3afc4361f2d8e114d8a87ff7ffa95405c647af7147501e9 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"row justify-content-around\">
        ...
        echo "\" class =\"btn btn-dark mb-4\">Ajouter une spécialité</a>
        </div>
    </div>
    ...
    <div class=\"row\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["specialite"]) {
            ...
            echo "                    <tr>
                        <td>";
            // line 35
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["specialite"], "nom", [], "any", false, false, false, 35), "html", null, true);
            echo "</td>
                        <td>
                            <a class=\"btn btn-primary\" title=\"Détails\" href=\"";
            // line 37
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("specialite-details", ["id" => twig_get_attribute($this->env, $this->source, $context["specialite"], "id", [], "any", false, false, false, 37)]), "html", null, true);
            echo "\">
            ...
            // line 43
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["specialite"], "id", [], "any", false, false, false, 43), "html", null, true);
            echo "\">
...
";
    ...
    {
        return new Source("", "specialite/index.html.twig", "C:\\xampp\\apps\\test\\templates\\specialite\\index.html.twig");
    }
}
